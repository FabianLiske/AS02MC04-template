...
VIVADO_ENV := REPO_ROOT="$(REPO_ROOT)" BUILD="$(ABS_BUILD)" TOP="$(TOP)" PART="$(PART)" BOARD_PART="$(BOARD_PART)" JOBS="$(JOBS)" HW_FREQ="$(HW_FREQ)" BOARD_CONSTRAINTS="$(BOARD_CONSTRAINTS)" LED_IOSTANDARD="$(LED_IOSTANDARD)" BOARD_AUTO_PORTS="$(BOARD_AUTO_PORTS)" BOARD_AUTO_IOSTANDARD="$(BOARD_AUTO_IOSTANDARD)"
